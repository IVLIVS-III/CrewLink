...
The new installer can be downloaded [here](https://storage.googleapis.com/crewlink-ivlivs.appspot.com/CrewLink%20Setup%202.0.1-m.1.exe).


<!--
### Using the modified server
Use this version together with the [modified server version](https://github.com/IVLIVS-III/CrewLink-server/tree/2.0.1-m.1).
-->
